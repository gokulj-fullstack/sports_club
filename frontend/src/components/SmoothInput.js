...
const Input = ({ className, wrapperClassName, ...props }) => {
  return (
...
const Skiper106 = () => {
  return (
    <div className="bg-[#0a0a0a] text-white flex h-full w-full flex-col items-center justify-center min-h-[300px] py-10">
      <div className="mb-8 grid content-start justify-items-center gap-6 text-center">
